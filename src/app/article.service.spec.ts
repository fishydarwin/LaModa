...
describe('ArticleService', () => {
  ...
  // it('#ofUser(2, 1) should return 2 articles', () => {
  //   let result = [];
  //   service.ofUser(2, 1).subscribe((articles) => { result = articles; });
  //   expect(result.length).toEqual(2);
  // })

  // it('#ofCategory(4, 1) has the first article\'s name start with Eyeliner', () => {
  //   let result: Article[] = [];
  //   service.ofCategory(4, 1).subscribe((articles) => { result = articles; });
  ...
  //       attachmentArray: [], creation_date: new Date()
  //     }
